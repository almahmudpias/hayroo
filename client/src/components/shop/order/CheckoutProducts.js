            ...
            return (
              ...
              >
                <div className="md:flex md:items-center md:space-x-4">
                  ...
                  <div className="md:ml-6 flex font-semibold text-gray-600 text-sm">
                    Price : <TbCurrencyTaka size={20}/>{product.pPrice}.00{" "}
                  </div>
                  <div className="md:ml-6 font-semibold text-gray-600 text-sm">
                    Quantitiy : {quantity(product._id)}
                  </div>
                  <div className="font-semibold flex text-gray-600 text-sm">
                    Subtotal : <TbCurrencyTaka size={20}/>{subTotal(product._id, product.pPrice)}.00
                  </div>
                </div>
              </div>
            );
