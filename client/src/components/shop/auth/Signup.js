      ...
      <form className="space-y-4">
        ...
        <div className="flex flex-col">
          ...
          <input
            ...
            } px-4 py-2 form focus:outline-none border`}
          />
        ...
        <div className="flex flex-col">
          ...
          <input
            ...
            } px-4 py-2 focus:outline-none form border`}
          />
        ...
        <div
          ...
          className="px-4 py-2 btn1 text-white text-center cursor-pointer font-medium"
        >
          Sign Up
        </div>
      </form>
