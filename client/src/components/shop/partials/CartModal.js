      ...
      >
        ...
        >
                        ...
                        <div className="relative w-full flex flex-col">
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div>
                              ...
                              <div style={{display: "flex"}}><TbCurrencyTaka  size={20} />{subTotal(item._id, item.pPrice)}.00</div>
          ...
          <div className="m-4 space-y-4">
            <div
              onClick={(e) => cartModalOpen()}
              className="cursor-pointer cart-button px-4 py-2 border border-gray-400  text-center cursor-pointer"
            >
              Continue shopping
            </div>
            {data.cartTotalCost ? (
              <Fragment>
                {isAuthenticate() ? (
                  <div 
                    className="px-4 cart-button1 text py-2   text-center cursor-pointer"
                    onClick={(e) => {
                      history.push("/checkout");
                      cartModalOpen();
                    }}
                  >  Checkout Tk {data.cartTotalCost}.00
                   
                  </div>
                ) : (
                  <div 
                    className="px-4 cart-button1 py-2 text bg-black text-center cursor-pointer"
                    onClick={(e) => {
                      history.push("/");
                      cartModalOpen();
                      dispatch({
