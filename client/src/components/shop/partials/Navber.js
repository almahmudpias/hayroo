...
import { BsAlipay, BsSearch } from "react-icons/bs";
...
const Navber = (props) => {
  ...
  return (
    <Fragment>
      ...
      {/* Navber Section */}
      <nav className="fixed top-0 w-full z-20 shadow-lg lg:shadow-none header-top-strip ">
        <div className="m-4 md:mx-12 md:my-4 grid grid-cols-4 lg:grid-cols-3">
          
          <div className="hidden lg:block col-span-1  flex text-white-600 mt-1">
            <span
              className="hover:bg-gray-200 color2  px-4 py-3 rounded-lg font-light tracking-widest hover:text-gray-800 cursor-pointer"
            ...
            <span
              className="hover:bg-Rajah-200 color2 px-4 py-3 rounded-lg font-light tracking-widest hover:text-gray-800 cursor-pointer"
          ...
          <div className="col-span-3 lg:hidden flex justify-items-stretch	 items-center">
            ...
            <span
              ...
              className="flex color items-left text-center font-bold uppercase text-white-800 text-2xl cursor-pointer px-2 text-center"
            >
          ...
          <div
            ...
            className="hidden lg:block flex items-left  text-center color text-white-800 font-bold tracking-widest uppercase text-2xl cursor-pointer"
          >
          ...
          <div className="flex items-right col-span-2 lg:col-span-1 flex justify-end">
            ...
            <div
              ...
              className=" svg rounded-lg px-2 py-2 cursor-pointer"
              title="Wishlist"
            >
              <svg
                className={`${
                  location.pathname === "/wish-list"
                    ...
                    : ""
                } w-8 h-8 svg text-gray-600 cursor-pointer`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
            ...
            {localStorage.getItem("jwt") ? (
              ...
              <div
                ...
                className="cursor-pointer svg px-2 py-2 rounded-lg"
                title="Login"
              >
                <svg
                  className="w-8 h-8 svg text-gray-600 hover:text-gray-800"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <div
              ...
              className="svg  px-2 py-2 rounded-lg relative cursor-pointer"
              title="Cart"
            >
              <svg
                className="w-8 svg h-8 text-gray-600 hover:text-gray-800"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
        ...
        >
          ...
          <div className="col-span-1 flex flex-col text-gray-600">
            <span
              className="color2 font-medium text-lg tracking-widest hover:text-gray-800 hover:bg-gray-200 px-3 py-2 rounded-lg cursor-pointer"
              onClick={(e) => history.push("/")}
            >
              Shop
            </span>
