          ...
          <div className="col-span-2 mt-8 md:mt-0 md:col-span-4 md:ml-6 lg:ml-12">
            <div className="flex flex-col leading-8">
              ...
              <div className="flex justify-between items-center">
                <span className="flex text-xl tracking-wider text-yellow-700">
                  <TbCurrencyTaka size={30}/>{sProduct.pPrice}.00
                </span>
                <span>
                  <svg
                ...
                <Fragment>
                  ...
                  layoutData.inCart.includes(sProduct._id) === true ? (
                    <div
                      ...
                      className={`px-4 py-2 cart1 text-white text-center cursor-not-allowed uppercase opacity-75`}
                    >
                      In Cart
                    </div>
                  ) : (
                    <div
                      ...
                      className={`px-4 py-2 cart1 text-white text-center cursor-pointer uppercase`}
                    >
                      Add to cart
                    </div>
                  )}
